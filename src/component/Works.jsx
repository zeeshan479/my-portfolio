...
const Works = () => {
  ...
  [
    {
      img: <img src='./project-images/livspace.png' className='w-full'/>,
      title: 'Livspace',
      domain: 'https://www.livspace.com'
    },
    {
      img: <img src='./project-images/shri chetanya.png' className='w-full'/>,
      title: 'Sri Chaitanya SCORE',
      domain: 'https://srichaitanyascore.com'
    },
    {
      img: <img src='./project-images/homelane.png' className='w-full'/>,
      title: 'HomeLane',
      domain: 'https://www.homelane.com'
    },
    {
      img: <img src='./project-images/vaishnavi.png' className='w-full'/>,
      title: 'Vaishnavi Interiors',
      domain: 'https://www.vaishnaviinteriors.in'
    },
    {
      img: <img src='./project-images/ugaao.png' className='w-full'/>,
      title: 'Ugaoo',
    ...
    <Layout>
      <div className='flex-1 p-12 h-[800px] main-container'>
        <div className='flex flex-col mt-6 gap-6 p-2'>
            <h1 className='text-3xl font-serif font-bold'>My Projects</h1>
